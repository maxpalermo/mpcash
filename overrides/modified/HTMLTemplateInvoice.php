...
$cashPath = dirname(__FILE__)
        . DIRECTORY_SEPARATOR . ".."
        . DIRECTORY_SEPARATOR . ".."
        . DIRECTORY_SEPARATOR . "modules"
        . DIRECTORY_SEPARATOR . "mpCash"
        . DIRECTORY_SEPARATOR . "classes"
        . DIRECTORY_SEPARATOR . "ClassCashFee.php";
$bankwirePath = dirname(__FILE__)
        . DIRECTORY_SEPARATOR . ".."
        . DIRECTORY_SEPARATOR . ".."
        . DIRECTORY_SEPARATOR . "modules"
        . DIRECTORY_SEPARATOR . "mpBankwire"
        . DIRECTORY_SEPARATOR . "classes"
        . DIRECTORY_SEPARATOR . "ClassBankwireFee.php";
$paypalPath = dirname(__FILE__)
        . DIRECTORY_SEPARATOR . ".."
        . DIRECTORY_SEPARATOR . ".."
        . DIRECTORY_SEPARATOR . "modules"
        . DIRECTORY_SEPARATOR . "mpPaypal"
        . DIRECTORY_SEPARATOR . "classes"
        . DIRECTORY_SEPARATOR . "ClassPaypalFee.php";

if(file_exists($cashPath)) {
    require_once $cashPath;
}
if(file_exists($bankwirePath)) {
    require_once $bankwirePath;
}
if(file_exists($paypalPath)) {
    require_once $paypalPath;
}
...
class HTMLTemplateInvoiceCore extends HTMLTemplate
{
    ...
    public function __construct(OrderInvoice $order_invoice, $smarty, $bulk_mode = false)
    {
        ...
        $module = $db->getValue($sql);
        
        if($module=='mpCash') {
            $this->fee = new ClassCashFee();
        } elseif ($module == 'mpBankwire') {
            $this->fee = new ClassBankwireFee();
        } elseif ($module == 'mpPaypal') {
            $this->fee = new ClassPaypalFee();
        } else {
            Tools:d('No module set for order ' . $id_order);
        }
        
        //ORDER FEE
        $this->fee->load((int)$id_order);
    ...
    public function getContent()
    {
        ...
        $footer = array(
            ...
            'fee_tax_excl' => $this->fee->getFeeTaxExcl(),
            'fee_tax_incl' => $this->fee->getFeeTaxIncl(),
            'total_tax_excl' => $this->fee->getTotalDocumentTaxExcl(),
            'total_tax_incl' => $this->fee->getTotalDocumentTaxIncl(),
        );
