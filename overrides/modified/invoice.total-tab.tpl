...
<table id="total-tab" width="100%">
	...
	<tr class="bold">
		...
		<td class="white">
                    {assign var=total_tax_excl value={$fee_summary->getTotalDocumentTaxExcl()}}
	...
	<tr class="bold">
		...
		<td class="white">
                    {assign var=total_taxes value={$fee_summary->getTotalDocumentTaxIncl() - $fee_summary->getTotalDocumentTaxExcl()}}
	...
	<tr class="bold">
		...
		<td class="white">
                    {assign var=total_tax_excl value={$fee_summary->getTotalCartTaxIncl()}}
                    {displayPrice currency=$order->id_currency price=$total_tax_excl}
		</td>
	</tr>
        {assign var=fee_tax_excl value=$fee_summary->getFeeTaxExcl()}
        {assign var=fee_tax      value=$fee_summary->getFeeTaxIncl()-$fee_summary->getFeeTaxExcl()}
        <tr class="bold">
		<td class="grey">
                    {if $fee_tax_excl<0}
	...
	<tr class="bold big">
		...
		<td class="white">
                    {assign var=total_document value=$fee_summary->getTotalDocumentTaxIncl()}
